...
//                               --dir_catalog /var/app/current
//                               --dir_iamge /mnt/efs/image
//
...
function write_config_files($options) {
	...
	$output .= '// DIR' . "\n";
	$output .= 'define(\'DIR_APPLICATION\', \'' . $options['dir_catalog'] . 'catalog/\');' . "\n";

	$output .= 'define(\'DIR_SYSTEM\', \'' . ($options['dir_catalog'] ? addslashes($options['dir_catalog']) : addslashes(DIR_OPENCART)) . 'system/\');' . "\n";
	$output .= 'define(\'DIR_IMAGE\', \'' . ($options['dir_image'] ? addslashes($options['dir_image']) : addslashes(DIR_OPENCART)) . 'image/\');' . "\n";
	$output .= 'define(\'DIR_STORAGE\', \'' . ($options['dir_storage'] ? addslashes($options['dir_storage']) : 'DIR_SYSTEM') . 'storage/\');' . "\n";
	...
	$output .= '// DIR' . "\n";
	$output .= 'define(\'DIR_APPLICATION\', \'' . ($options['dir_catalog'] ? addslashes($options['dir_catalog']) : addslashes(DIR_OPENCART)) . 'admin/\');' . "\n";
	$output .= 'define(\'DIR_SYSTEM\', \'' . ($options['dir_catalog'] ? addslashes($options['dir_catalog']) : addslashes(DIR_OPENCART)) . 'system/\');' . "\n";
	$output .= 'define(\'DIR_IMAGE\', \'' . ($options['dir_image'] ? addslashes($options['dir_image']) : addslashes(DIR_OPENCART))  . 'image/\');' . "\n";	
	//$output .= 'define(\'DIR_STORAGE\', DIR_SYSTEM . \'storage/\');' . "\n";
	$output .= 'define(\'DIR_STORAGE\', \'' . ($options['dir_storage'] ? addslashes($options['dir_storage']) : 'DIR_SYSTEM') . 'storage/\');' . "\n";
	$output .= 'define(\'DIR_CATALOG\', \'' . ( $options['dir_image'] ? addslashes($options['dir_catalog']) : addslashes(DIR_OPENCART) ) . 'catalog/\');' . "\n";
	$output .= 'define(\'DIR_LANGUAGE\', DIR_APPLICATION . \'language/\');' . "\n";
